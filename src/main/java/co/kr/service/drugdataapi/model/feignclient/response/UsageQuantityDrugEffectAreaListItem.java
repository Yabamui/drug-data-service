...
@JsonDeserialize(builder = UsageQuantityDrugEffectAreaListItem.UsageQuantityDrugEffectAreaListItemBuilder.class)
public class UsageQuantityDrugEffectAreaListItem {
    @JsonProperty("diagYm")
