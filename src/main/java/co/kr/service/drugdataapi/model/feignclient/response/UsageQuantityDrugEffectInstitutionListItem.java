...
@JsonDeserialize(builder = UsageQuantityDrugEffectInstitutionListItem.UsageQuantityDrugEffectInstitutionListItemBuilder.class)
public class UsageQuantityDrugEffectInstitutionListItem {
    @JsonProperty("clCdNm")
