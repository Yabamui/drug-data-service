...
@JsonDeserialize(builder = UsageQuantityATCStep4InstitutionListItem.UsageQuantityATCStep4InstitutionListItemBuilder.class)
public class UsageQuantityATCStep4InstitutionListItem {
    @JsonProperty("diagYm")
