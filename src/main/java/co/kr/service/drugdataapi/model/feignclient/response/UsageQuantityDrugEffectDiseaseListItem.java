...
@JsonDeserialize(builder = UsageQuantityDrugEffectDiseaseListItem.UsageQuantityDrugEffectDiseaseListItemBuilder.class)
public class UsageQuantityDrugEffectDiseaseListItem {
    @JsonProperty("diagYm")
